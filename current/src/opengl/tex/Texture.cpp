...
//#include "../vertex/VertexData2D.hpp"

GLenum DEFAULT_TEXTURE_WRAP = GL_REPEAT;
TexturedPolygon2D *Texture::mTexturedPolygon2D = NULL;
...
void Texture::setTexturedPolygon2D(TexturedPolygon2D *program) {
...
bool Texture::loadPixelsFromFile8(std::string path) {
	freeTexture();
...
bool Texture::loadTextureFromPixels8(void) {
	bool success = true;
...
void Texture::createPixels8(GLuint imgWidth, GLuint imgHeight) {
	if (imgWidth > 0 && imgHeight > 0) {
		...
		mTextureHeight = imgWidth; //imgHeight
...
bool Texture::loadPixelsFromFile32(std::string path) {
	freeTexture();
...
bool Texture::loadTextureFromFile32(std::string path) {
...
bool Texture::loadTextureFromFileWithColorKey32(std::string path, GLubyte r, GLubyte g, GLubyte b, GLubyte a) {
...
bool Texture::loadTextureFromPixels32(void) {
	bool success = true;
...
bool Texture::loadTextureFromPixels32(GLuint *pixels, GLuint imgW, GLuint imgH, GLuint texW, GLuint texH) {
	freeTexture();
...
GLubyte *Texture::getPixelData8(void) {
	return mPixels8;
}
...
GLuint *Texture::getPixelData32(void) {
	return mPixels32;
}
...
GLuint Texture::textureWidth(void) {
	return mTextureWidth;
}

GLuint Texture::textureHeight(void) {
	return mTextureHeight;
}

GLuint Texture::imageWidth(void) {
	return mImageWidth;
}

GLuint Texture::imageHeight(void) {
	return mImageHeight;
}
